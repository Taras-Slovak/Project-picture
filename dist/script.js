...
/* harmony import */ var _modules_checkTesxtInputs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/checkTesxtInputs */ "./src/js/modules/checkTesxtInputs.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_checkTesxtInputs__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="name"]');
  Object(_modules_checkTesxtInputs__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="message"]');
...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var calcFunc = function calcFunc() {
    ...
    if (sizeBlock.value == '' || materialBlock.value == '') {
      resultBlock.textContent = 'Please, select the size and picture material';
...
/***/ "./src/js/modules/checkTesxtInputs.js":
/*!********************************************!*\
  !*** ./src/js/modules/checkTesxtInputs.js ***!
  \********************************************/
/*! exports provided: default */
...
var checkTesxtInputs = function checkTesxtInputs(selector) {
...
/* harmony default export */ __webpack_exports__["default"] = (checkTesxtInputs);
...
var forms = function forms() {
  ...
  var clearInputs = function clearInputs() {
    ...
    upload.forEach(function (item) {
      item.previousElementSibling.textContent = 'The file is not selected';
    });
  };
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener("click", function (e) {
        ...
        fixedgift.style.marginRight = "".concat(scroll, "px");
      });
    });
